...
class TeacherConversationDetailPage extends ConsumerStatefulWidget {
  ...
  ConsumerState<TeacherConversationDetailPage> createState() =>
      _TeacherConversationDetailPageState();
}

class _TeacherConversationDetailPageState
    extends ConsumerState<TeacherConversationDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final studentNameAsync =
        ref.watch(studentNameProvider(widget.conversation.studentId));
  ...
  Widget _buildNormalBar(bool hasText) {
    return Row(
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(Icons.image_outlined,
                color: _isUploading ? Colors.grey : _kBlue, size: 22),
          ),
        ),
        const SizedBox(width: 10),
        Expanded(
          child: Semantics(
            identifier: 'teacher_conversation_field_message',
            child: Container(
              decoration: BoxDecoration(
        ...
        const SizedBox(width: 10),
        Semantics(
          identifier: 'teacher_conversation_btn_send',
          child: GestureDetector(
  ...
  Widget _buildRecordingBar() {
    return Row(
      children: [
        ...
        const Spacer(),
        Semantics(
          identifier: 'teacher_conversation_btn_cancel_recording',
          child: GestureDetector(
        ...
        const SizedBox(width: 10),
        Semantics(
          identifier: 'teacher_conversation_btn_send_recording',
          child: GestureDetector(
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(
              ...
              color: widget.isMe ? Colors.white : _kBlue,
              size: 22,
            ),
          ),
        ),
